      ...
      }
      {
        ceramicLoaded && viewForm && (
          <div className={formStyle}>
            ...
            {
              profileImage && (
                <Image width={'200px'} loader={myLoader} unoptimized={true} className={profileImageStyle} src={profileImage} alt={'profile pic'} />
              )
            }
          ...
          <div>
            ...
            }
            {
              profile.profileImage && (
                <Image width={'200px'} loader={myLoader} src={profile.profileImage} alt={'profile pic'} />
              )
            }
          </div>
        ) : null
